                    ...
                    <ul class="userInfoBox">
                        ...
                        <li class="avatarlist">
                            ...
                            <el-upload
                              ...
                              <div slot="tip" class="el-upload__tip">点击上传头像，只能上传jpg/png文件，不得超过1MB</div>
                            </el-upload>
                        </li>
                        <!-- 昵称 -->
                        <li class="username">
    ...
    export default {
        ...
        data() { 
            return {
                isEdit: false,
                userInfo:'',//本地存储的用户信
                userInfoObj:'',// 用户的信息{avatar:头像，username，description，sex:0(男)，email，head_start}
                wwwHost:"http://"+window.location.host,//图片域名 ，拼接url字符串
            }
        },
        methods: { 
            handleAvatarSuccess(res, file) {//  上传 头像
